...
LANE_SPECS: dict[str, dict[str, Any]] = {
    "l0_equal": {
        "matrix_id": "L0-equal",
        "description": "Matched equal-weight control; not the optimization target.",
        "config_overrides": {"model.equal_weight_fusion": True},
        "runtime_env": {},
    },
    "l1_learned": {
        "matrix_id": "L1-learned",
        "description": "Canonical learned-weighting mainline anchor.",
        "config_overrides": {},
        "runtime_env": {},
    },
    "l2_minimal": {
        "matrix_id": "L2-minimal",
        "description": "Minimal learned ablation with raw confidence heads.",
        "config_overrides": {"model.minimal_fusion_baseline": True},
        "runtime_env": {},
    },
    "l3_no_mixer": {
        "matrix_id": "L3-no-mixer",
        "description": "Ablation: disable cross-view mixer while keeping calibrator.",
        "config_overrides": {},
        "runtime_env": {"ANKLE_DISABLE_FUSION_CROSS_VIEW_MIXER": "1"},
    },
    "l4_no_calibrator": {
        "matrix_id": "L4-no-calibrator",
        "description": "Ablation: disable shared calibrator while keeping cross-view mixer.",
        "config_overrides": {},
