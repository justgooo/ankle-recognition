...
FORMAL_CONFIGS = [
    "configs/cmp_fair_v100_formal_resunet.yaml",
    "configs/cmp_fair_v100_formal_resnext.yaml",
    "configs/cmp_fair_v100_formal_senet.yaml",
    "configs/cmp_fair_v100_formal_cspnet.yaml",
]
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Dry-run or execute the fair backbone formal comparison on one or more GPUs."
    )
    ...
    parser.add_argument(
        ...
        nargs="+",
        type=int,
        help="Optional list of GPU ids to use concurrently, e.g. --gpu-ids 0 1 2.",
    )
    parser.add_argument(
        "--timeout",
        type=int,
...
def print_plan(python_executable: str, gpu_ids: list[int], timeout_seconds: int, log_dir: Path) -> None:
    ...
    print("")
    print("============================================================")
    print(" Fair Backbone Formal Compare")
