...
| 指标 | 值 | 来源 commit | 配置 |
|------|---:|-------------|------|
| **零漏诊 val_Acc** | **0.798** | `053cb3a` | View Reliability Gating, non-shared, lr=5e-5, d=0.3, aug=true, ls=0.0 |
| 零漏诊 val_Spe | 0.620 | `053cb3a` | 同上 |
| 不漏诊阈值 | 0.370 | `053cb3a` | 同上 |
| val_AUC (参考) | 0.960 | `053cb3a` | 同上 |
